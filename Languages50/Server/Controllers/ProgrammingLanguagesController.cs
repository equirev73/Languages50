...
namespace Languages50.Server.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ProgrammingLanguagesController : ControllerBase
    {
        private readonly Languages50ServerContext _context;

        public ProgrammingLanguagesController(Languages50ServerContext context)
        {
            _context = context;
        }
